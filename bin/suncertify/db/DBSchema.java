...
public final class DBSchema
{
   ...
   *
   * @param fieldIndex the field index represented by one of the index constants of
   *                   this class
   ...
   *
   * @param fieldName a string representing the field name whose index is to be
   *                  determined
   ...
   *
   * @param fieldNameAnyCase a string representing the case-insensitive field name whose
