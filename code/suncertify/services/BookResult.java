...
public class BookResult implements Serializable
{
   ...
   *
   * @param bookStatus An enumeration constant representing the status of the booking
   ...
   * @param contractor A <code>Contractor</code> object representing the record field
