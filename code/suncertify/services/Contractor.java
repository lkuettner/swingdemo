...
public class Contractor implements Serializable
{
   ...
   *
   * @param name the subcontractor name. The name of the subcontractor the
   *             corresponding record relates to.
   */
   ...
   * Sets the location.
   *
   * @param location the city. The locality in which this contractor works.
   */
   ...
   *
   * @param specialties types of work performed. Comma separated list of types of work
   ...
   * Sets the size.
   *
   * @param size the number of staff in organization. The number of workers
   *             available when the corresponding record is booked.
   */
   ...
   * Sets the rate.
   *
   * @param rate the hourly charge. Charge per hour for the subcontractor. This
   *             field includes the currency symbol.
   */
   ...
   * Sets the owner.
   *
   * @param owner the customer holding the corresponding record. The id value
