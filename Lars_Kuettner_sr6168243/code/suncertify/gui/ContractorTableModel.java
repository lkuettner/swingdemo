...
public class ContractorTableModel extends AbstractTableModel {
     ...
     * 
     * @param contractors
     *            a map of (record number, contractor) pairs with the
     ...
     * 
     * @param row
     *            the index of the row whose contractor is to be replaced
     * @param c
     *            the new contractor with which to replace an existing
     *            contractor
     */
     ...
     * 
     * @param row
     *            the index of the row for which the record is to be deleted
     */
