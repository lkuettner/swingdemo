...
public interface DBAccess {
     ...
     * @param data
     *            the string array representing the record with which to update
     *            the current record
     * @param lockCookie
     ...
     * 
     * @param data
     *            the string array representing the record to be created
     * @return a long value representing the record number of the newly created
     *         record
     * @throws DuplicateKeyException
     *             is actually never thrown (in this version at least) as it was
