...
public interface BusinessServices {
     ...
     * 
     * @param recNo
     *            the record number of the record to book acting as the primary
     *            key into the database
     * @param contractor
     *            the <code>Contractor</code> object with which to update the
