...
public final class ContractorManagerConnector {
     ...
     *             if the Singleton instance of the data access class could not
     *             be obtained
     */
     ...
     * 
     * @param hostname
     *            a string representing the host name or IP address of the
     *            server
     * @param port
     *            the RMI port number in string representation
     * @return the looked-up contractor manager remote object
     * @throws RemoteException
     *             if the lookup failed because of a malformed URL or because
